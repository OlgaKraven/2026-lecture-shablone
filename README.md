...
Не меняйте компоненты для подстановки дисциплины. `src/engine` содержит общие компоненты, `public/course.json` — демонстрационные данные. Новые курсы должны использовать собственные данные и тематическое изображение. Демонстрация содержит 41 слайд; это набор образцов, а не полный курс по РПД.
