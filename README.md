...
Версия **0.1.0**: общий движок, данные курса отдельно, повторное использование компонентов без копирования оформления. Шаблон согласован пользователем 12 сентября 2026 года.
...
Не меняйте компоненты для подстановки дисциплины. `src/engine` содержит общие компоненты, `public/course.json` — демонстрационные данные. Новые курсы должны использовать собственные данные и тематическое изображение. Демонстрация содержит 76 слайдов; это набор образцов, а не полный курс по РПД.
